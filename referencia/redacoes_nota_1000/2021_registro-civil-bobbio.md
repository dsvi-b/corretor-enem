# Redação nota 1000 — ENEM 2021 (abordagem alternativa)
...
> Segunda nota-1000 do **mesmo tema** (ver `2021_registro-civil.md`), com
> repertório e proposta diferentes — útil pra mostrar que **não há fórmula
> única**: dois caminhos distintos atingem o teto.

---

## Texto

Norberto Bobbio, cientista político italiano, afirma que a democracia é um processo que tem, em seu cerne, o objetivo de garantir a representatividade política de todas as pessoas. Para que o mecanismo democrático funcione, então, é fundamental apresentar uma rede estatal que dê acesso a diversos recursos, como alimentação, moradia, educação, segurança, saúde e participação eleitoral. Contudo, muitos brasileiros, por não terem uma certidão de nascimento, são privados desses direitos básicos e têm seus próprios papéis de cidadãos invisibilizados. Logo, deve-se discutir as raízes históricas desse problema e as suas consequências nocivas.
...
**C1 (200):** Norma sólida; pequeno deslize de modo verbal ("recebam") não
reincidente — confirma que 200 tolera 1 falha isolada.

**C2 (200):** Repertório de áreas distintas — Bobbio (ciência política, retomado
na conclusão), Marx (materialismo histórico), "Vidas Secas"/Graciliano (literatura).
Articulação forte: Bobbio abre e **fecha** o texto (moldura).

**C3 (200):** Projeto explícito ("raízes históricas" + "consequências"); cada
desenvolvimento cobre um. Retomada de Bobbio no fim = fechamento autoral.

**C4 (200):** "Contudo", "Logo", "Primeiramente", "Sob esse viés", "Além disso",
"Ademais", "Portanto", "Por conseguinte" — repertório coesivo expressivo.

**C5 (200):** **Agente** (Estado + movimentos sociais/comunidades/órgãos),
**ação** (mutirão "Meu Registro, Minha Identidade"), **meio** (envio de
profissionais a todas as cidades), **efeito** (reparar injustiças + solidificar
democracia), **detalhamento** (nome do projeto + cadastro em outros serviços).

## Padrões reaproveitáveis
- **Moldura**: abrir e fechar com o mesmo teórico (Bobbio) = coesão global.
- Repertório literário **específico** (personagens nomeados) vale mais que menção vaga.
- Comparado à outra nota-1000 do mesmo tema: repertórios totalmente diferentes,
  ambos teto → o que importa é articulação, não "qual" repertório.
